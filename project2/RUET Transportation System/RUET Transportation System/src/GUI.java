...
public class GUI{
	...
	String FRAME_TITLE = "RUET Transportation System";
	...
	GUI() throws Exception{
		...
		labelUsername = new JLabel("Username-ID ");
		...
		btnUserLoginAttempt.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(users.illegalUserTextInput(textfieldUsername.getText()) || users.illegalUserTextInput(String.valueOf(passwordFieldUser.getPassword()))){
					...
					labelUserMarketHeader = new JLabel("VEHICLES");
					...
					labelUserMarketItemIDHeader = new JLabel("Vehicle ID");
					...
					labelUserMarketItemNameHeader = new JLabel("Vehicle Name");
					...
					labelUserMarketPricePerQuantityHeader = new JLabel("Price/Seat");
					...
					labelUserMarketQuantityHeader = new JLabel("Seat");
					...
					labelProfileUsername = new JLabel("Username-ID");
					...
					labelUserOrdersHeader = new JLabel("BOOKINGS");
					...
					labelUserOrderIDHeader = new JLabel("Booking ID");
					...
					labelUserOrderDateHeader = new JLabel("Booking Date");
					...
					// user market buttons
					btnUserMarket = new JButton("Vehicles");
					...
					btnUserMarketPlaceOrder = new JButton("BOOK");
					...
					// user orders buttons
					btnUserOrders = new JButton("Bookings");
					...
					btnUserMarket.addActionListener(new ActionListener(){
						...
						@Override
						public void actionPerformed(ActionEvent arg0) {
							System.out.println(username + " User Vehicle panel");
					...
					btnUserMarketPlaceOrder.addActionListener(new ActionListener(){
						...
						public void actionPerformed(ActionEvent arg0) {
							try{
								...
								JOptionPane.showMessageDialog(null, "Successfully booked your seat!", "Confirm", JOptionPane.INFORMATION_MESSAGE);
								btnUserMarketPlaceOrder.setEnabled(false);
						...
						public void actionPerformed(ActionEvent arg0) {
							for(int i=0; i<=orders.newOrderID; i++){
								if(checkboxUserOrders[i].isSelected()){
									...
									JLabel labelPricePerQuantityHeader = new JLabel("Price/Seat");
									...
									JLabel labelQuantityHeader = new JLabel("Seat");
					...
					JOptionPane.showMessageDialog(null, "Username-ID or Password doesn't match!", "Error", JOptionPane.ERROR_MESSAGE);
				}
			}
		...
		btnUserSignupPanel.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				labelSignupUsername = new JLabel("Username-ID ");
				...
				btnAdminLoginAtttempt.addActionListener(new ActionListener(){
					...
					public void actionPerformed(ActionEvent arg0) {	
						...
						if(!String.valueOf(passwordFieldAdmin.getPassword()).equals(ROOT_PASSWORD)){
							...
							labelAdminControlUserIDHeader = new JLabel("Index");
							...
							labelAdminControlUsernameHeader = new JLabel("Username-ID");
							...
							// market labels
							labelAdminMarketHeader = new JLabel("VEHICLES");
							...
							// element add items
							labelAdminMarketAddItemName = new JLabel("Vehicle Name");
							labelAdminMarketAddItemName.setBounds(280, 150, 100, 30);
							...
							// label display items
							labelAdminMarketItemIDHeader = new JLabel("Vehicle ID");
							...
							labelAdminMarketItemNameHeader = new JLabel("Vehicle Name");
							...
							labelAdminMarketPriceHeader = new JLabel("Price/Seat");
							...
							// view orders labels
							labelAdminViewOrdersHeader = new JLabel("VIEW BOOKINGS");
							...
							labelAdminOrderIDHeader = new JLabel("Booking ID");
							...
							labelAdminOrderDateHeader = new JLabel("Booking Date");
							...
							labelAdminOrderUsernameHeader = new JLabel("Username-ID");
							...
							labelAdminAddItemsHeader = new JLabel("ADD NEW VEHICLE");
							...
							btnAdminMarket = new JButton("Vehicles");
							...
							btnAdminViewOrders = new JButton("View Bookings");
								...
								public void actionPerformed(ActionEvent arg0) {
									for(int i=0; i<=users.newUserID; i++){
										if(checkboxAdminControl[i].isSelected()){
											...
											System.out.println("deleting vehicle: " + i + " " + users.username[i] + " " + users.mobileNo[i]);
											users.removeUser(i);
							...
							btnAdminMarket.addActionListener(new ActionListener(){
								...
								@Override
								public void actionPerformed(ActionEvent arg0) {
									System.out.println("Admin vehicles panel");
								...
								public void actionPerformed(ActionEvent arg0) {
									for(int i=0; i<=items.newItemID; i++){
										if(checkboxAdminMarket[i].isSelected()){
											...
											System.out.println("deleting vehicle: " + i + " " + items.itemName[i] + " " + items.price[i]);
									...
									try {
										System.out.println("Saving vehicleinfo....");
										items.saveIteminfo();
										items = new Items();
									} catch (Exception e) {
										e.printStackTrace();
							...
							btnAdminViewOrders.addActionListener(new ActionListener(){
								...
								@Override
								public void actionPerformed(ActionEvent arg0) {
									System.out.println("Admin View Bookings panel");
								...
								public void actionPerformed(ActionEvent arg0) {
									for(int i=0; i<=orders.newOrderID; i++){
										if(checkboxAdminOrders[i].isSelected()){
											...
											JLabel labelUsername = new JLabel("Username-ID: " + orders.username[i]);
											labelUsername.setBounds(100, 100, 400, 50);
											labelUsername.setFont(new Font(FONT_DEFAULT, Font.BOLD, FONT_HEADER2_SIZE));
		...
		frame.addWindowListener(new WindowAdapter(){
			public void windowClosing(WindowEvent e){
				...
				try {
					...
					System.out.println("Saving vehicleinfo....");
					items.saveIteminfo();
					System.out.println("Saving bookinginfo....");
					orders.saveOrderInfo();;
				} catch (Exception e1) {
